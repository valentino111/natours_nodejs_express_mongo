...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripePublicKey = 'pk_test_51NMv3PICrCtrlQJ2iuO6Qi3QGNLe5uh3QJpkDtnPuXPaJ2t5aLbE5reHrUGurUygObzF89X7tvfxUQ74BrbKrOf100UnRfrS8b';
          _context.prev = 1;
          _context.next = 4;
          return _axios.default.get("/api/v1/bookings/checkout-session/".concat(tourId));
        case 4:
          response = _context.sent;
          session = response.data.session; // 2) Initialize Stripe
          _context.next = 8;
...
},{"axios":"../../node_modules/axios/index.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js","./alerts":"alerts.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var addReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(review, rating, tourId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"favorites.js":[function(require,module,exports) {
"use strict";
...
var createFavorite = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userId, tourId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Tour Added to Favorites!');
            window.setTimeout(function () {
              location.reload();
            }, 1500);
          }
  ...
  return function createFavorite(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.createFavorite = createFavorite;
var deleteFavorite = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(favoriteId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "/api/v1/favorites/".concat(favoriteId)
          });
        case 3:
          res = _context2.sent;
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Tour Removed from Favorites.');
            window.setTimeout(function () {
              location.reload();
            }, 1500);
          }
  ...
  return function deleteFavorite(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
